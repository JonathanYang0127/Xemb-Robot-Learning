...
def teleop():
    ...
    try:
        while keyboard_handler.running:
            master_left_joints = [0.061359234154224396, -1.9757672548294067, 1.5815342664718628, 0.003067961661145091, 0.11658254265785217, 0.004601942375302315]
            master_right_joints = master_left_joints
            master_left_gripper = -1.0
            master_right_gripper = master_left_gripper
