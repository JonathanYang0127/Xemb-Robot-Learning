...
open_tab_and_run "echo 'Activating conda environment and starting puppet follow script...'; source ~/interbotix_ws/devel/setup.bash && source ~/miniconda3/etc/profile.d/conda.sh && conda activate aloha && cd ~/interbotix_ws/src/xemb_aloha/xemb_scripts && python puppet_follow_both.py"
